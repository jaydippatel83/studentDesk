...
export default function Comments(props) {
  ...
  const { data, error, isLoading } = useMoralisCloudFunction("getAllMintedPost");
  ...
  return (
    <div className="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
          ...
          <div className="row ps-2 pe-2">
            <div className="col-sm-12 p-1">
              <img
                width="100%"
                height="300"
                src={`${element.saveData["postImage"]
      ...
      <div className="card-body d-flex p-0">
        ...
        >
          <i className="feather-arrow-up text-white bg-primary-gradiant me-1 btn-round-xs font-xss "></i>{" "}
        ...
        <div
          ...
          className="emoji-bttn pointer d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss me-2"
        >
          <i className="feather-arrow-down text-white  bg-primary-gradiant me-2 btn-round-xs font-xss"></i>
          {element.dislikes}
        </div>
