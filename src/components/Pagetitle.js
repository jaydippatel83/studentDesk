...
export default function Pagetitle() {
    ...
    async function handleSubmit() {
        ...
        const file = new Moralis.File("contest.json", { base64: btoa(JSON.stringify(contest)) });
    ...
    useEffect(() => {
        ...
        contest ? contest.map((cont, index) => {
        ...
        <div className="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
            ...
            <div className="d-flex justify-content-between">
                ...
                <Box sx={{ width: '100%', typography: 'body1' }}>
                    <TabContext value={value}>
                        <Box style={{ display: 'flex', justifyContent: 'space-between' }} sx={{ borderBottom: 1, borderColor: 'divider' }}>
                            ...
                            <Nav.Link className="" variant="primary" >
                                <Button className=" contest h4" onClick={handleShow}>Create Contest</Button>
                            </Nav.Link>
                        </Box>
            ...
            <Modal show={show} onHide={handleClose} style={{ overflowY: 'scroll' }}>
                <Modal.Header className="theme-dark-bg" closeButton>
                    <Modal.Title className="h4" style={{ fontWeight: "600" }}>Contest</Modal.Title>
                </Modal.Header>
                    ...
                    >
                        ...
                        <div className="form-group icon-input  p-2">
                            <input onChange={(e) => setTitle(e.target.value)}
                             type="text" className=" h4 bor-0 w-100 rounded-xxl p-3 card text-grey-900 font-xsss fw-600 border-light-md" placeholder="Contest Title" />
                        </div>
                        <div className="d-flex mx-2 my-2">
                            <LocalizationProvider dateAdapter={AdapterDateFns}>
                                <DesktopDatePicker
                                    ...
                                    renderInput={(params) => <TextField style={{ marginRight: '10px' }}
                                     className="align-self-center card" {...params} />}
                                />
                            ...
                            <LocalizationProvider  dateAdapter={AdapterDateFns}>
                                <DesktopDatePicker
                                    ...
                                    renderInput={(params) => <TextField className="align-self-center h4 card" {...params} />}
                                />
                            </LocalizationProvider>
                        </div>
                        <div className="form-group icon-input   p-2">
                            <input onChange={(e) => setPrize(e.target.value)} type="number" className="h4 bor-0 w-100 rounded-xxl p-3    font-xsss fw-600 border-light-md card" placeholder="Prize Amount" />
                        </div>
                        <div>
                            <div className="form-group icon-input  p-2">
                                <textarea onChange={(e) => setDescription(e.target.value)} 
                                name="message" className="h100 h4 bor-0 w-100 rounded-xxl p-3    font-xsss fw-600 border-light-md card" cols="20" rows="10" placeholder="Criteria and Description"></textarea>
                            </div>

                        </div>
                        <div className="form-group icon-input  p-2 mx-2 card">
                            <FormControl sx={{ minWidth: 120, width: '100%' }} className="card">
                                <InputLabel className="theme-dark-bg h4" id="demo-simple-select-helper-label">Contest Types</InputLabel>
                                <Select
                                ...
                                >
                                    ...
                                    <MenuItem className="h4 card" value={1}>Meme Competetion</MenuItem>
                                    <MenuItem className="h4 card" value={2}>Bountry program</MenuItem>
                                    <MenuItem className="h4 card" value={3}>Airdrop Campaign</MenuItem>
                                </Select>
                            </FormControl>
                        </div>
